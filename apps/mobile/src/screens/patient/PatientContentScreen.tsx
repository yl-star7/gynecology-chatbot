      ...
      >
        <Card variant="muted">
          <Text style={styles.eyebrow}>
            {section === "knowledge" ? "참고 정보" : "날짜별 기록"}
          </Text>
          ...
          <Text style={styles.description}>
            {error ??
              (section === "knowledge"
                ...
                : "남겨둔 기록을 다시 읽으면서 오늘의 흐름을 차분히 정리해봐요.")}
          </Text>
        </Card>
        ...
        {section === "knowledge" && featuredItem ? (
          <Card variant="accent">
            ...
            <Text style={styles.cardBody}>
              오늘 읽은 내용을 바탕으로 아기에게 하고 싶은 말을 천천히 정리해볼
              수 있어요.
            </Text>
        ...
        <View style={styles.list}>
          {items.map((item, index) => (
            <Pressable
              ...
              onPress={() =>
                router.push(
                  `/chat/link/${item.section}?entityId=${encodeURIComponent(item.id)}`,
                )
              }
            >
