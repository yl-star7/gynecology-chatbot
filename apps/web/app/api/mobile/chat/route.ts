          ...
          generate: async () =>
            generateText({
              ...
              system: [
                ...
                "6. AI 공감 대화: 사용자의 답에 공감·정상화·의미화한 뒤 **부드러운 열린 후속 질문 1개**로 끝내 대화를 이어가세요. **턴 수 상한은 두지 마세요.** 사용자가 이어가고 싶은 만큼 계속 주고받으세요. 이 단계에서는 quickReplies를 생략하고 사용자가 입력창으로 자유롭게 답하도록 하세요.",
                "7. 공감 대화 마무리: 사용자가 '괜찮아졌어요', '고마워요', '위로됐어요', '오늘은 여기까지' 처럼 **스스로 해소/감사/종료 의사를 표현할 때만** '오늘 하루도 고생 많았어요. 내일 또 만나요' 같은 따뜻한 마무리 인사와 함께 quickReplies ['오늘은 여기까지 할래요', '조금 더 이야기할래요']를 제시하세요. 자동으로 종료하지 마세요.",
