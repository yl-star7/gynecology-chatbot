...
export function AdminContentSection({
  ...
  const rootClassName = view === "all" ? styles.panelGrid : styles.sectionStack;
    ...
    <section className={rootClassName}>
      {showStatic ? (
        <section className={`${styles.panel} ${styles.panelWide}`}>
          ...
          <div className={styles.weekManagementGrid}>
            ...
            <div className={styles.panelHeader}>
              <div>
                ...
                <p className={styles.panelDescription}>
                  문서를 선택해 상태를 확인하고, 오른쪽에서 새 문서를 작성하거나
                  기존 문서를 수정합니다.
                </p>
              </div>
            </div>
          ...
          <section className={styles.panel}>
            <div className={styles.managementGrid}>
              <div className={styles.formGrid}>
                <div className={styles.panelHeader}>
                  <div>
                    <h3 className={styles.panelTitle}>문서 목록</h3>
                    <p className={styles.panelDescription}>
                      문서를 먼저 고르면 오른쪽 편집 영역이 해당 문서 기준으로
                      채워집니다.
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.list}>
                  {ragDocuments.map((document) => (
                    <button
                      ...
                      type="button"
                      aria-pressed={selectedRagDocumentId === document.id}
              ...
              <div className={styles.formGrid}>
                <div className={styles.panelHeader}>
                  <div>
                    <h3 className={styles.panelTitle}>
                      {selectedRagDocument ? "선택 문서 편집" : "새 문서 작성"}
                    </h3>
                    <p className={styles.panelDescription}>
                      선택한 문서의 제목, 주차, 카테고리, 본문을 수정하거나 새
                      문서를 작성합니다.
                    </p>
                  </div>
                </div>
                ...
                {selectedRagDocument ? (
                  <div className={styles.detailGrid}>
                    <div className={styles.panelStat}>
                      <span className={styles.metaLabel}>선택 문서</span>
                      <strong>{selectedRagDocument.title}</strong>
                      <span className={styles.listMeta}>
                        {selectedRagDocument.updatedAt}
                      </span>
                    </div>
                    <div className={styles.panelStat}>
                      <span className={styles.metaLabel}>문서 상태</span>
                      <strong>
                        {getDocumentStatusLabel(selectedRagDocument.status)}
                      </strong>
                      <span className={styles.listMeta}>
                        {selectedRagDocument.pregnancyWeekLabel} ·{" "}
                        {selectedRagDocument.category}
                      </span>
                    </div>
                  </div>
                ) : null}
                ...
                <>
                  ...
                  <div className={styles.panelHeader}>
                    <div>
                      ...
                      <p className={styles.panelDescription}>
                        주차 안의 `Day 1~7` 본문과 아기/산모 문구를 직접
                        수정합니다.
                      </p>
                    </div>
                    <button
                        ...
                        >
                          ...
                          <div className={styles.rowActions}>
                            ...
                            <button
                              ...
                              type="button"
                              disabled={
                                index === selectedWeekDetail.days.length - 1
                              }
                              onClick={() => onMoveWeekDay(index, 1)}
                              aria-label="Day 아래로"
                            >
                  ...
                  <div className={styles.panelHeader}>
                    <div>
                      ...
                      <p className={styles.panelDescription}>
                        Storage bucket/object path 기준으로 주차 또는 day
                        이미지를 연결합니다.
                      </p>
                    </div>
                    <button
