    ...
    <main className="mx-auto flex min-h-screen w-full max-w-[520px] flex-col justify-center gap-4 px-4 py-5">
      ...
      {step === 0 && (
        <MobileCard className="p-6">
          ...
          <button
            className="mt-4 w-full rounded-full bg-[var(--accent)] py-3 text-sm font-semibold text-white"
            onClick={next}
            type="button"
          >
            다음
      ...
      {step === 1 && (
        <MobileCard className="p-6">
          ...
          <div className="mt-4 flex gap-3">
            <button
              className="flex-1 rounded-full border border-[var(--line)] py-3 text-sm font-semibold text-[var(--text-soft)]"
              onClick={() => setStep(0)}
              type="button"
            >
              이전
            ...
            <button
              className="flex-1 rounded-full bg-[var(--accent)] py-3 text-sm font-semibold text-white"
              onClick={() => {
                setError(null);
                setStep(2);
              }}
      ...
      {step === 3 && (
        <MobileCard className="p-6">
          ...
          <div className="mt-4 flex gap-3">
            ...
            <button
              className="flex-1 rounded-full bg-[var(--accent)] py-3 text-sm font-semibold text-white disabled:opacity-60"
