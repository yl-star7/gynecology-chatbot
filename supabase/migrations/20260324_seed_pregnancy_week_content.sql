...
VALUES (
  ...
  '입덧과 피로가 완화되며, 기운이 조금씩 돌아오기 시작해요. (1),; 가슴·배에 파란 정맥이 파랗게 드러날 수도 있어요.임신 중에는 혈액이 많이 필요해서 30~50%가량 혈액량이 증가하기 때문이에요.',
  '오늘 함께 해 봐요',
  '아기와 나누는 마음',
  'published',
  timezone('utc', now())
...
SELECT pwd.id, 1, '13주 1일차',
  ...
  '{"items": ["입덧과 피로가 완화되며, 기운이 조금씩 돌아오기 시작해요. (1),", "가슴·배에 파란 정맥이 파랗게 드러날 수도 있어요.임신 중에는 혈액이 많이 필요해서 30~50%가량 혈액량이 증가하기 때문이에요.", "체중이 서서히 늘고, 자궁이 골반 밖으로 올라오면서 아랫배가 도드라질 수 있어요."]}'::jsonb,
...
SELECT pwd.id, 2, '13주 2일차',
  '{"items": ["두개골과 긴 뼈가 단단해지고, 치아 구조·손톱·발톱이 형성돼요.", "손목과 발목도 만들어집니다.", "눈은 머리 옆에서 앞으로 이동(2)해 제자리를 찾아가고, 얼굴 윤곽이 뚜렷해지고 있어요."]}'::jsonb,
  '{"items": ["임신 중기에 들어서면서 조금 편안해지지만,아직 초기의 증상이 바로 사라지지 않을 수 있고,불편한 증상도 나타날 수 있어요. (1),", "코막힘, 속쓰림, 잇몸 출혈 같은 불편감이 생길 수 있어요.(1)(3)  이는 혈액량 증가와 호르몬 변화 때문이며 대부분 정상이에요.(1)(3) 잇몸에 작은 출혈은 호르몬 영향이지만,통증이 심하거나 염증이 동반되면 검진 때 알려야 해요!", "속쓰림이 심하다면 식사 후 껌을 씹어 위산을 중화시켜보세요!그래도 증상이 나아지지 않는다면 위험하지 않은 속쓰림 약을 추천해드릴게요."]}'::jsonb,
...
SELECT pwd.id, 3, '13주 3일차',
  '{"items": ["아기는 양수를 삼키고 소변을 만들어 배출할 수 있어요..(1),", "삼킨 양수는 장에 모여 첫 대변인 ‘태변’을 이룹니다..(1),"]}'::jsonb,
...
FROM wd CROSS JOIN (VALUES
    ...
    (5, 'w15-d5-cl-1', '편하고 예쁜 임부복을 쇼핑해보세요! (1)(3).', '편하고 예쁜 임부복을 쇼핑해보세요! (1)(3).', '{"items": [{"id": "w15-d5-cl-1", "label": "편하고 예쁜 임부복을 쇼핑해보세요! (1)(3)."}]}'::jsonb, 1, true),
...
FROM wd CROSS JOIN (VALUES
    ...
    (3, 'w15-d3-q-1', '“오늘은 아이에게 ‘부드러움’이 가진 힘에 대해 이야기 해볼 거에요.부드러움은 다른 사람을 어떻게 변화시키나요?”', 'text', '편하게 적어 주세요.', '{}'::jsonb, 1, false),
    ...
    (5, 'w15-d5-q-2', '“오늘은 아기에게 ‘휴식’에 대해 이야기해봅시다.진정한 ‘휴식’이란 어떤 것 인가요?”', 'text', '편하게 적어 주세요.', '{}'::jsonb, 2, false),
...
SELECT pwd.id, 5, '16주 5일차',
  '{"items": ["아기의 간기능이 발달하면서 이 시기부터 (16–18주) AFP(신경관 결손 선별)나, 상황에 따라 쿼드 스크린을 권할 수 있어요. 양수검사(15–20주)는 선택적 진단검사예요. (1)(3)중요한 검사인 만큼 병원에 방문하면 우리 아기에게 필요한지 꼭 확인해주세요."]}'::jsonb,
...
FROM wd CROSS JOIN (VALUES
    ...
    (2, 'w16-d2-q-1', '“이번주 속이 불편하진 않았나요?어떤 증상을 경험했나요”', 'text', '편하게 적어 주세요.', '{}'::jsonb, 1, false),
    ...
    (3, 'w16-d3-q-1', '“오늘은 ‘실수’에 대해서 이야기 해봐요.기억에 남는 실수가 있나요?”', 'text', '편하게 적어 주세요.', '{}'::jsonb, 1, false),
...
VALUES (
  19,
  '19주차 발달 정보',
  '오늘 아기는 키 약 24–25cm, 몸무게 약 270–300g, 손에 쥘 수 있는 석류 하나 크기만큼 자랐어요.(1),; 손가락과 발가락에는 영원히 변하지 않을 지문과 발자국 무늬가 드디어 완성되었어요. 일란성 쌍둥이도 서로 다른, 오직 자기만의 무늬예요.',
  '자궁의 끝부분이 배꼽 근처까지 올라와 배가 더 ‘임산부 배’처럼 둥글게 보이기 시작해요.; 체형에 따라 어떤 사람은 배가 많이 나온 것 같고, 어떤 사람은 덜 나온 것처럼 보여서 걱정되기도 하지만, 의사가 아기 성장과 체중 증가를 괜찮다고 한다면 배 모양과 크기 차이는 전부 정상 범위예요.(1),',
  '오늘 함께 해 봐요',
  '아기와 나누는 마음',
  'published',
  timezone('utc', now())
...
SELECT pwd.id, 1, '19주 1일차',
  '{"items": ["오늘 아기는 키 약 24–25cm, 몸무게 약 270–300g, 손에 쥘 수 있는 석류 하나 크기만큼 자랐어요.(1),", "손가락과 발가락에는 영원히 변하지 않을 지문과 발자국 무늬가 드디어 완성되었어요. 일란성 쌍둥이도 서로 다른, 오직 자기만의 무늬예요."]}'::jsonb,
  '{"items": ["자궁의 끝부분이 배꼽 근처까지 올라와 배가 더 ‘임산부 배’처럼 둥글게 보이기 시작해요.", "체형에 따라 어떤 사람은 배가 많이 나온 것 같고, 어떤 사람은 덜 나온 것처럼 보여서 걱정되기도 하지만, 의사가 아기 성장과 체중 증가를 괜찮다고 한다면 배 모양과 크기 차이는 전부 정상 범위예요.(1),"]}'::jsonb,
...
FROM wd CROSS JOIN (VALUES
    ...
    (1, 'w19-d1-cl-3', '체형을 숨기기보다 편하고 숨 쉬기 좋은 옷을 골라 입어보기. (내 몸을 있는 그대로 받아들이는 연습이기도 해요.) (1).', '체형을 숨기기보다 편하고 숨 쉬기 좋은 옷을 골라 입어보기. (내 몸을 있는 그대로 받아들이는 연습이기도 해요.) (1).', '{"items": [{"id": "w19-d1-cl-3", "label": "체형을 숨기기보다 편하고 숨 쉬기 좋은 옷을 골라 입어보기. (내 몸을 있는 그대로 받아들이는 연습이기도 해요.) (1)."}]}'::jsonb, 3, true),
...
SELECT pwd.id, 3, '21주 3일차',
  '{"items": ["아기의 입 안에는 어른보다 더 많은 미뢰 봉우리가 있어, 엄마가 먹는 음식에 따라 살짝 달라지는 양수의 맛을 민감하게 느끼기 시작해요.", "엄마가 다양한 음식을 먹을수록 양수의 맛도 미세하게 변해, 아기가 뱃속에서 여러 가지 맛에 노출될 수 있고, 이는 출생 후 식습관에도 영향을 줄 수 있는 것으로 여겨져요. (1)(3)(8)(9))"]}'::jsonb,
...
SELECT pwd.id, 5, '21주 5일차',
  '{"items": ["21주차의 중요한 발달 중 하나는 두개골의 능선(머리뼈 봉합 부위의 융기)이 형성되는 것으로, 우리 문화권에서 ‘숨구멍’이라고 부르는 부위가 출생 후까지 유연하게 열려 있어, 분만 시 머리가 잘 맞추어 지나갈 수 있게 해줘요.", "여자 아기라면 이미 자궁이 형성되어 있고, 평생 사용할 난자들이 난소 안에서 만들어진 상태예요. (3)(8) 남자 아기라면 고환이 형성되었지만 아직 복부 안에 머물러 있고, 앞으로 몇 주~몇 달 동안 서서히 음낭으로 내려오게 됩니다."]}'::jsonb,
...
SELECT pwd.id, 7, '21주 7일차',
  '{"items": ["연구에 따르면, 태아의 신경계는 적어도 임신 24–25주 이전까지는 통증을 경험할 만큼 발달하지 않은 상태로 여겨져요. (3) -", "오늘도 아기는 하루 12–14시간 정도를 자는 것으로 추정되고, 깨어 있는 시간엔 움직이고, 태동으로 엄마에게 자신의 존재를 꾸준히 알려주고 있어요."]}'::jsonb,
...
FROM wd CROSS JOIN (VALUES
    ...
    (1, 'w23-d1-cl-3', '다리·허벅지 혈관이 도드라져 보인다면, 하루 중 10–15분 정도는 다리를 심장보다 높게 올리고 쉬는 시간을 만들어, 정맥류와 붓기를 조금이나마 덜어주기. (1)(5)(6)(8)4) 태교 질문', '다리·허벅지 혈관이 도드라져 보인다면, 하루 중 10–15분 정도는 다리를 심장보다 높게 올리고 쉬는 시간을 만들어, 정맥류와 붓기를 조금이나마 덜어주기. (1)(5)(6)(8)4) 태교 질문', '{"items": [{"id": "w23-d1-cl-3", "label": "다리·허벅지 혈관이 도드라져 보인다면, 하루 중 10–15분 정도는 다리를 심장보다 높게 올리고 쉬는 시간을 만들어, 정맥류와 붓기를 조금이나마 덜어주기. (1)(5)(6)(8)4) 태교 질문"}]}'::jsonb, 3, true),
...
SELECT pwd.id, 4, '27주 4일차',
  '{"items": ["눈꺼풀이 열리고 닫히는 기능이 더 정교해져, 아기는 실제로 눈을 뜨고 빛과 어둠, 기본적인 형태를 구별할 수 있을 정도로 시력이 발달해요.", "강한 빛(여름 직사광선, 핸드폰 플래시 등)이 배 쪽으로 비치면 아기가 놀라거나 깨어나 태동이 많아질 정도로 빛에 민감해져요. (8)(9) 다만 일부러 강한 빛을 오래 비추는 건 아기에게 스트레스가 될 수 있으니 피하는 것이 좋아요."]}'::jsonb,
...
FROM wd CROSS JOIN (VALUES
    ...
    (4, 'w27-d4-q-2', '“아기가 빛에 민감해진 지금, 아기에게 보여주고 싶은 색은 어떤 색인가요?지금의 계절과 관련하여 대답해봅시다.봄, 여름,가을,겨울의 어떤 색을 보여주고 싶나요?', 'text', '편하게 적어 주세요.', '{}'::jsonb, 2, false),
...
FROM wd CROSS JOIN (VALUES
    ...
    (3, 'w28-d3-q-1', '“살아오면서, 무언가를 시작하기 전 수없이 연습해 보았던 순간이 있나요? 그리고 실제로 그 첫 무대에 섰을 때, 그떄의 감상은 어떤가요?연습과 비슷했나요 혹은 달랐나요?', 'text', '편하게 적어 주세요.', '{}'::jsonb, 1, false),
    ...
    (7, 'w28-d7-q-1', '“아직 12주가량 시간이 더 있어야 하겠지만 3분기의 시작은 출산을 향한 세번째 계단에 올라섰음을 의미해요.아직 이를 수 있지만 어렴풋이 출산을 떠올릴 때 가장 먼저 떠오르는 감정은 무엇인가요?”', 'text', '편하게 적어 주세요.', '{}'::jsonb, 1, false),
    (7, 'w28-d7-q-2', '“출산을 떠올릴 때, ‘어떻게 지지받고 싶을까’에 초점을 맞춘다면, 나는 누구에게 어떤 역할을 부탁하고 싶나요?”엄마,남편,친구 등등 생각해볼까요?', 'text', '편하게 적어 주세요.', '{}'::jsonb, 2, false)
) AS v(day_number, code, question_text, question_type, help_text, question_payload, display_order, is_required)
ON CONFLICT (week_data_id, day_number, code) DO UPDATE SET
  question_text = EXCLUDED.question_text, question_type = EXCLUDED.question_type,
  help_text = EXCLUDED.help_text, question_payload = EXCLUDED.question_payload,
...
FROM wd CROSS JOIN (VALUES
    ...
    (1, 'w30-d1-cl-2', '• 계단이나 언덕을 오를 때, 예전의 속도를 기준으로 삼지 말고, 두 번에 한 번은 중간에 잠깐 멈춰 서서 숨을 고르는 ‘휴식 지점’을 정해 놓기. (1)(2)(3)(5)
• 철분·비타민C·칼슘이 포함된 한 끼를 직접 준비해 보세요. (쇠고기·간·달걀·시금치 같은 철분 식품에 브로콜리·케일·두부·요거트 같은 칼슘 식품을 더하고, 귤·키위·파프리카처럼 비타민 C가 풍부한 채소·과일을 곁들이면 철분이 더 잘 흡수되어 엄마의 피로와 어지러움을 줄이고 아기의 뇌·신경 발달에도 도움이 됩니다. (1)(3)(8))', '• 계단이나 언덕을 오를 때, 예전의 속도를 기준으로 삼지 말고, 두 번에 한 번은 중간에 잠깐 멈춰 서서 숨을 고르는 ‘휴식 지점’을 정해 놓기. (1)(2)(3)(5)
• 철분·비타민C·칼슘이 포함된 한 끼를 직접 준비해 보세요. (쇠고기·간·달걀·시금치 같은 철분 식품에 브로콜리·케일·두부·요거트 같은 칼슘 식품을 더하고, 귤·키위·파프리카처럼 비타민 C가 풍부한 채소·과일을 곁들이면 철분이 더 잘 흡수되어 엄마의 피로와 어지러움을 줄이고 아기의 뇌·신경 발달에도 도움이 됩니다. (1)(3)(8))', '{"items": [{"id": "w30-d1-cl-2", "label": "• 계단이나 언덕을 오를 때, 예전의 속도를 기준으로 삼지 말고, 두 번에 한 번은 중간에 잠깐 멈춰 서서 숨을 고르는 ‘휴식 지점’을 정해 놓기. (1)(2)(3)(5)\n• 철분·비타민C·칼슘이 포함된 한 끼를 직접 준비해 보세요. (쇠고기·간·달걀·시금치 같은 철분 식품에 브로콜리·케일·두부·요거트 같은 칼슘 식품을 더하고, 귤·키위·파프리카처럼 비타민 C가 풍부한 채소·과일을 곁들이면 철분이 더 잘 흡수되어 엄마의 피로와 어지러움을 줄이고 아기의 뇌·신경 발달에도 도움이 됩니다. (1)(3)(8))"}]}'::jsonb, 2, true),
    (2, 'w30-d2-cl-1', '• 오늘 평소보다 한 컵만 더 물 마시기. 피로감을 줄이고 어지러움·두통을 예방하는 가장 기본적인 방법은 “물과 균형 잡힌 식사”라는 사실을 기억해 주세요. (1)(3)(5)(8)(9)
• 최근에 꾼 꿈이 이상하게 기억에 남는다면, 그 내용을 “내 꿈 공장이 과장해서 만든 드라마”라고 생각하고 수첩에 적어보기. 그 안에는 출산이나 엄마가 되는 일에 대한 나의 작은 불안이 살짝 숨어 있을 수 있답니다. (3)(5)
• 오늘은 병원 가방에서 한 가지 준비물을 선택해 실제로 넣어 보세요.', '• 오늘 평소보다 한 컵만 더 물 마시기. 피로감을 줄이고 어지러움·두통을 예방하는 가장 기본적인 방법은 “물과 균형 잡힌 식사”라는 사실을 기억해 주세요. (1)(3)(5)(8)(9)
• 최근에 꾼 꿈이 이상하게 기억에 남는다면, 그 내용을 “내 꿈 공장이 과장해서 만든 드라마”라고 생각하고 수첩에 적어보기. 그 안에는 출산이나 엄마가 되는 일에 대한 나의 작은 불안이 살짝 숨어 있을 수 있답니다. (3)(5)
• 오늘은 병원 가방에서 한 가지 준비물을 선택해 실제로 넣어 보세요.', '{"items": [{"id": "w30-d2-cl-1", "label": "• 오늘 평소보다 한 컵만 더 물 마시기. 피로감을 줄이고 어지러움·두통을 예방하는 가장 기본적인 방법은 “물과 균형 잡힌 식사”라는 사실을 기억해 주세요. (1)(3)(5)(8)(9)\n• 최근에 꾼 꿈이 이상하게 기억에 남는다면, 그 내용을 “내 꿈 공장이 과장해서 만든 드라마”라고 생각하고 수첩에 적어보기. 그 안에는 출산이나 엄마가 되는 일에 대한 나의 작은 불안이 살짝 숨어 있을 수 있답니다. (3)(5)\n• 오늘은 병원 가방에서 한 가지 준비물을 선택해 실제로 넣어 보세요."}]}'::jsonb, 1, true),
    (3, 'w30-d3-cl-1', '• 거울 앞에 섰을 때 가장 먼저 보이는 변화 하나를 골라, “이건 내가 엄마가 되기 위해 얻은 표시”라고 이름 붙여 보기. (3)(5)(6)(9)
• 배나 몸에 털이 늘어나 속상하다면, 지금 내 몸이 호르몬을 뿜어내가며 하고 있는 일을 생각해보기: “나의 몸은 오늘도 아기의 체온과 영양을 지키고 있다.” (3)(5)(6)(9)
• 초유 분비가 보인다면 속옷 안쪽에 수유 패드나 부드러운 거즈를 두기(브라 안쪽에 얇게 패드를 대어 옷이 젖는 것을 막고, 샤워 후에는 자극적이지 않은 보습제를 살짝 발라 피부를 보호해 주시면 좋습니다.)', '• 거울 앞에 섰을 때 가장 먼저 보이는 변화 하나를 골라, “이건 내가 엄마가 되기 위해 얻은 표시”라고 이름 붙여 보기. (3)(5)(6)(9)
• 배나 몸에 털이 늘어나 속상하다면, 지금 내 몸이 호르몬을 뿜어내가며 하고 있는 일을 생각해보기: “나의 몸은 오늘도 아기의 체온과 영양을 지키고 있다.” (3)(5)(6)(9)
• 초유 분비가 보인다면 속옷 안쪽에 수유 패드나 부드러운 거즈를 두기(브라 안쪽에 얇게 패드를 대어 옷이 젖는 것을 막고, 샤워 후에는 자극적이지 않은 보습제를 살짝 발라 피부를 보호해 주시면 좋습니다.)', '{"items": [{"id": "w30-d3-cl-1", "label": "• 거울 앞에 섰을 때 가장 먼저 보이는 변화 하나를 골라, “이건 내가 엄마가 되기 위해 얻은 표시”라고 이름 붙여 보기. (3)(5)(6)(9)\n• 배나 몸에 털이 늘어나 속상하다면, 지금 내 몸이 호르몬을 뿜어내가며 하고 있는 일을 생각해보기: “나의 몸은 오늘도 아기의 체온과 영양을 지키고 있다.” (3)(5)(6)(9)\n• 초유 분비가 보인다면 속옷 안쪽에 수유 패드나 부드러운 거즈를 두기(브라 안쪽에 얇게 패드를 대어 옷이 젖는 것을 막고, 샤워 후에는 자극적이지 않은 보습제를 살짝 발라 피부를 보호해 주시면 좋습니다.)"}]}'::jsonb, 1, true),
    (4, 'w30-d4-cl-1', '• 식사량을 줄이는 대신, 한 번에 먹는 양을 조금 줄이고, 횟수를 나누어 먹는 “소량·다회 식사”를 시도해 보기. (1)(3)(5)(7)(9)
• 속옷을 갈아입을 때 분비물의 색·양을 하루에 한 번만 가볍게 확인해 보기.
(갈색 분비물인지, 선홍색 피가 섞여 있는지, 물처럼 흘러내리는 느낌이 있는지 살펴보는 것만으로도, 이슬·출혈·양막 파수를 구분하고 위험 신호를 빨리 알아차리는 데 큰 도움이 됩니다.) (1)(3)
• 혹시 선홍색 분비물이나 물 같은 분비물이 나오면 닦지 말고 깨끗한 패드·거즈에 받아 그대로 병원에 가져가세요.', '• 식사량을 줄이는 대신, 한 번에 먹는 양을 조금 줄이고, 횟수를 나누어 먹는 “소량·다회 식사”를 시도해 보기. (1)(3)(5)(7)(9)
• 속옷을 갈아입을 때 분비물의 색·양을 하루에 한 번만 가볍게 확인해 보기.
(갈색 분비물인지, 선홍색 피가 섞여 있는지, 물처럼 흘러내리는 느낌이 있는지 살펴보는 것만으로도, 이슬·출혈·양막 파수를 구분하고 위험 신호를 빨리 알아차리는 데 큰 도움이 됩니다.) (1)(3)
• 혹시 선홍색 분비물이나 물 같은 분비물이 나오면 닦지 말고 깨끗한 패드·거즈에 받아 그대로 병원에 가져가세요.', '{"items": [{"id": "w30-d4-cl-1", "label": "• 식사량을 줄이는 대신, 한 번에 먹는 양을 조금 줄이고, 횟수를 나누어 먹는 “소량·다회 식사”를 시도해 보기. (1)(3)(5)(7)(9)\n• 속옷을 갈아입을 때 분비물의 색·양을 하루에 한 번만 가볍게 확인해 보기.\n(갈색 분비물인지, 선홍색 피가 섞여 있는지, 물처럼 흘러내리는 느낌이 있는지 살펴보는 것만으로도, 이슬·출혈·양막 파수를 구분하고 위험 신호를 빨리 알아차리는 데 큰 도움이 됩니다.) (1)(3)\n• 혹시 선홍색 분비물이나 물 같은 분비물이 나오면 닦지 말고 깨끗한 패드·거즈에 받아 그대로 병원에 가져가세요."}]}'::jsonb, 1, true),
...
(두 다리의 부기 정도가 비슷한지, 한쪽만 유난히 붓거나 통증이 있는지 살펴보고, 이상이 느껴지면 바로 의료진에게 문의하세요.)', '{"items": [{"id": "w30-d5-cl-3", "label": "• 아침에 한번, 저녁에 한번 양쪽 다리와 발의 부기 정도를 한 번씩 비교해 보기.\n(두 다리의 부기 정도가 비슷한지, 한쪽만 유난히 붓거나 통증이 있는지 살펴보고, 이상이 느껴지면 바로 의료진에게 문의하세요.)"}]}'::jsonb, 3, true),
    ...
    (7, 'w30-d7-cl-1', '• 남편과 함께 “아기를 맞이할 차 안의 자리”를 한 번 같이 둘러보기. 카시트를 어디에 설치할지, 병원에서 돌아오는 길에 어떤걸 준비하면 좋을지 함께 대화해보세요. (1)(3)(7)(9)
• 반려동물이 있다면, 출산과 산후 첫 몇 주 동안 돌봄 방식을 어떻게 조정할지 간단한 계획을 세워보기. (3)
• 오늘만큼은 아빠(또는 주 양육자)가 “태교 담당”이 되어도 좋아요. 동화 한 편 읽어주기, 배를 쓰다듬으며 인사하기', '• 남편과 함께 “아기를 맞이할 차 안의 자리”를 한 번 같이 둘러보기. 카시트를 어디에 설치할지, 병원에서 돌아오는 길에 어떤걸 준비하면 좋을지 함께 대화해보세요. (1)(3)(7)(9)
• 반려동물이 있다면, 출산과 산후 첫 몇 주 동안 돌봄 방식을 어떻게 조정할지 간단한 계획을 세워보기. (3)
• 오늘만큼은 아빠(또는 주 양육자)가 “태교 담당”이 되어도 좋아요. 동화 한 편 읽어주기, 배를 쓰다듬으며 인사하기', '{"items": [{"id": "w30-d7-cl-1", "label": "• 남편과 함께 “아기를 맞이할 차 안의 자리”를 한 번 같이 둘러보기. 카시트를 어디에 설치할지, 병원에서 돌아오는 길에 어떤걸 준비하면 좋을지 함께 대화해보세요. (1)(3)(7)(9)\n• 반려동물이 있다면, 출산과 산후 첫 몇 주 동안 돌봄 방식을 어떻게 조정할지 간단한 계획을 세워보기. (3)\n• 오늘만큼은 아빠(또는 주 양육자)가 “태교 담당”이 되어도 좋아요. 동화 한 편 읽어주기, 배를 쓰다듬으며 인사하기"}]}'::jsonb, 1, true)
) AS v(day_number, code, title, description, checklist_payload, display_order, is_required)
ON CONFLICT (week_data_id, day_number, code) DO UPDATE SET
  title = EXCLUDED.title, description = EXCLUDED.description,
  checklist_payload = EXCLUDED.checklist_payload, display_order = EXCLUDED.display_order,
